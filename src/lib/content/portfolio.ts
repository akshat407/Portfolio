...
export const author = {
  ...
  email: 'srivastava.akshat407@gmail.com',
};

export const seoData = {
  title: 'Akshat Srivastava | Front-End Developer',
  description:
    'Akshat Srivastava is a front-end developer who specializes in building (and occasionally designing) exceptional visual interfaces.',
  author: author.name,
  image:
